...
HD_PWD='C:/Users/raoab/OneDrive/Desktop/IMPORTANT FILES/Verilog/Parking Garage2/Parking Garage2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parkingMaster.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parkingMaster.tcl
